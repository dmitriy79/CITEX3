...
color: #DFE2E8;}
          ...
          .title-right{
              ...
              ul{
                  ...
                  height: 100%;
                  li{ display: flex;    align-items: center;    margin-right: 40px;
                    .img-wrap{
                      width: 22px;
                      height: 22px;
                      margin-right: 7px;
  ...
  .transaction-middle{
      ...
      .transaction-middle-left{
          ...
          .panel-center{width:20%;margin:0 8px 0 12px;background: #292F37;position: relative;}
          .panel-right{  
                width: 26%;
        margin-left: 0.8%;}
      }
       .transaction-middle-right{    width: 21.5%;}
  }
}
</style>
