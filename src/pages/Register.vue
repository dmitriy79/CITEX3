<template>
    <div class="register-wrapper">
        ...
        <div class="content" ref="content">
            <div class="left">
                <div class="title">欢迎注册<router-link to="/login" tag="div">登陆</router-link></div>
                <div class="input-item">
                    <div class="input-wrapper">
                         <input type="email" placeholder="请输入邮箱" v-model="email" ><button class="input-btn" @click="sendEmail" :plain="true" ref="sendEmail">{{content}}</button>
                    </div>
                     <div class="input-wrapper">
...
//    background:#292f37 url("~@/assets/images/login-bg.png") no-repeat 74% center;
    ...
    bottom: 9px;}
        ...
        .input-item{
            .select-wrapper{font-size: 14px;
color: #A6A7AD;margin-bottom:17px;
                i{margin-right: 8px;
...
.input-btn{
    background: #33383f;position: absolute;right: 0;padding: 0 15px;cursor: pointer;    border: none;outline:none;
    height: 48px;
    color: #fff;    width: 114px;
}
    input{
        font-size: 14px;
color: #A6A7AD;width: 100%
        ...
        .register-btn{background: #2286FF;cursor: pointer;
