...
.entrust-panel{display: none;height: 294px;
    tr{width: 100%}
    .header{opacity: 0.5;
        background: #181F27;
        th{
        ...
        dt{opacity: 0.5;
background: #181F27;    height: 25px;
    line-height: 25px;}
    dd{height: 25px;line-height: 25px}
    dt,dd{
        span{width: 19.3%;display: inline-block;font-size: 12px;    padding-left: 20px;
color: #8D9398;}
    }
}
</style>
